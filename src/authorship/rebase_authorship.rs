...
fn run_diff_tree_for_commits(
    ...
    // Feed commit SHAs directly — diff-tree will compare each commit against its first parent
    ...
    for commit_sha in commit_shas {
        ...
        commit_deltas.push((commit_sha.clone(), delta));
    }
